...
def dense_debug_preferences() -> UiPreferences:
    ...
    return UiPreferences(
        ...
        hud=HudPreferences(
            ...
            show_assignment_warning_markers=True,
            assignment_target_highlight_color=base.hud.assignment_target_highlight_color,
            action_summary_default="review",
            action_summary_max_labels=10,
            movement_budget_ring_mode=base.hud.movement_budget_ring_mode,
            show_chain_breadcrumbs=True,
            text_scale=0.9,
            high_contrast=True,
        ),
...
def command_bench_preferences() -> UiPreferences:
    ...
    return UiPreferences(
        ...
        hud=HudPreferences(
            ...
            composition_profile="command-bench-hud",
